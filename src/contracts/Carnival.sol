...
contract Carnival is ERC1155Token{
    ...
    mapping(uint256 => uint256) public relatedNFTCount;
    ...
    //watch video
    function watchVideo(uint256 _tokenId) public payable {
      //Fetch the video creator
      address receiver = creators[_tokenId];
      payable(receiver).transfer(msg.value);
    }

    function addViewer(uint256 _tokenId) public {        
        views[_tokenId].push(msg.sender);
    }
